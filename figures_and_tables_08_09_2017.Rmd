...
```{r figure4a, echo=FALSE, cache=FALSE}
##################################################
...
```{r figure4b, echo=FALSE, cache=FALSE}
##################################################
# Read saved results of simulations achieving API
##################################################
...
```{r simulations, cache=FALSE, echo=FALSE}
##################################################
...
```{r figure5, cache=FALSE, echo=FALSE}
##################################################
...
```{r figure6, cache=FALSE, echo=FALSE}
##################################################
# Simulation study parameters
##################################################
x.vec <- c(psi=0.2, lambda=1/2.5, w=0.0025, beta=0.8)
...
mpanel <- function(x.vec,
  ...
  if(parname == 'w')
    ybreaks <- seq(0.0020, 0.0040, by=0.0005)
  if(parname == 'lambda')
    ybreaks <- seq(0.0, 0.6, by=0.1)
  if(parname == 'beta')
    ybreaks <- seq(0.6, 1.0, by=0.1)
